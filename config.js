...
configData.general = {
  ...
  serverToken: process.env.SERVER_TOKEN || "change-me",           // A unique token to your application that servers will use to authenticate to each other
  welcomeMessage : "Welcome to the Forest API!",                  // The welcome message seen by TCP and webSocket clients upon connection
